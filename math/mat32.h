...
namespace Odin {
    ...
    struct Mat32{
		...
		public:
			...
			inline Mat32(void) {
				mat[0] = 1; mat[2] = 0; mat[4] = 0;
				mat[1] = 0; mat[3] = 1; mat[5] = 0;
			}
			
			inline Mat32(const float m11, const float m12, const float m21, const float m22, const float m31, const float m32) {
				mat[0] = m11; mat[2] = m21; mat[4] = m31;
				mat[1] = m12; mat[3] = m22; mat[5] = m32;
			}
			
			inline Mat32(const Mat2& m) {
				mat[0] = m[0]; mat[2] = m[1]; mat[4] = 0;
				mat[1] = m[2]; mat[3] = m[3]; mat[5] = 0;
			}
			
			inline Mat32(const Mat2& m, const Vec2& v) {
				mat[0] = m[0]; mat[2] = m[2]; mat[4] = v.x;
				mat[1] = m[1]; mat[3] = m[3]; mat[5] = v.y;
			}
			...
			inline Mat32(const Vec2& v, const float angle) {
				...
				mat[0] = c; mat[2] = -s; mat[4] = v.x;
				mat[1] = s; mat[3] = c; mat[5] = v.y;
			}
