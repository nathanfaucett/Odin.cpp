...
namespace Odin {
	...
	template <typename Type> inline Mat43<Type>& Mat43<Type>::operator -(void) {
	...
	template <typename Type> inline Mat43<Type>& Mat43<Type>::LookAt(Vec3<Type>& eye, Vec3<Type>& target, Vec3<Type>& up) {
