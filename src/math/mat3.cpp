...
namespace Odin {
	...
	template <typename Type> inline Mat3<Type>& Mat3<Type>::operator -() {
	...
	template <typename Type> inline void Mat3<Type>::operator *=(const Mat3<Type>& m) {
		Type a11 = m_mat[0], a12 = m_mat[3], a13 = m_mat[6],
		     a21 = m_mat[1], a22 = m_mat[4], a23 = m_mat[7],
		     a31 = m_mat[2], a32 = m_mat[5], a33 = m_mat[8],
	...
	template <typename Type> inline void Mat3<Type>::operator *=(Type s) {
		m_mat[0] *= s;
		m_mat[1] *= s;
		m_mat[2] *= s;
		m_mat[3] *= s;
